      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-2/3 space-y-4">
            {cart.length > 0 ? (
              cart.map((product) => (
                <div key={product._id} className="bg-white p-4 rounded-lg shadow-sm text-black flex items-start gap-4">
          ...
          <div className="w-full md:w-1/3">
            <div className="bg-white border rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-green-700 mb-4">Total: €{calculateTotal().toFixed(2)}</h2>
